...
public class Parser {
    ...
    public ArrayList<String> readSenarioFile(String filepath) throws FileNotFoundException {
    ...
    public int parseSimulationCount(ArrayList<String> lines) throws InvalidSimulationCountException {
    ...
    public ArrayList<Flyable> parseAircrafts(ArrayList<String> lines) {
