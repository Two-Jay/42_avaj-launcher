...
// }
// Flyable flyable = aircraftFactory.newAircraft(type, name, longitude,
// latitude, height);
...
// System.out.println("Exception : invalid number format for coordinates. (" +
// line + ")");
// System.exit(1);
// }
// }
...
// private static boolean isValidCoordinates(int longitude, int latitude, int
// height) {
// return longitude >= 0 && latitude >= 0 && height >= 0 && height <= 100 &&
// latitude < 300 && longitude < 300;
// }
